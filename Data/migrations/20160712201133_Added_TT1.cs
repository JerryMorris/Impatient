...
{
    public partial class Added_TT1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    DateModifiedIfActive = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateModifiedIfActive = table.Column<DateTime>(nullable: false),
                    FirebaseNurseKey = table.Column<string>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateModifiedIfActive = table.Column<DateTime>(nullable: false),
                    Dependency = table.Column<int>(nullable: false),
                    FirebasePatientKey = table.Column<string>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeResponded = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Messages_Nurses_NurseId",
                        column: x => x.NurseId,
