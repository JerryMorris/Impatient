var PatientApp;
(function (PatientApp) {
    angular.module('PatientApp', ['ui.router', 'ngResource', 'ui.bootstrap', 'angular.filter', 'firebase', 'angularMoment', 'yaru22.angular-timeago']).config(function ($stateProvider, $urlRouterProvider, $locationProvider) {
        // Define routes
        $stateProvider
            .state('home', {
            url: '/',
    ...
    angular.module('PatientApp').factory('authInterceptor', function ($q, $window, $location) {
        return ({
